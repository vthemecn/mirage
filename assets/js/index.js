      ...
      document.querySelectorAll('.delete-comment').forEach(link => {
          link.addEventListener('click', async function(e) {
              ...
              try {
                  ...
                  if (result.success) {
                      ...
                      if (commentItem) {
                          ...
                          setTimeout(() => {
                              ...
                              // 显示成功消息
                              showNotification$1('评论删除成功', 'success');
                          }, 300);
                      }
                  } else {
                      showNotification$1(result.data.message || '删除失败', 'error');
                      // 恢复按钮状态
                  ...
                  showNotification$1('网络错误，请重试', 'error');
                  // 恢复按钮状态
                  this.textContent = originalText;
                  this.style.pointerEvents = 'auto';
              }
